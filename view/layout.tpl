  ...
  $(".pinned").pin();
      ...
      <div id="pageFooter" class="center">
        ...
        <div id="footerContainer">
          <center><div class="center">ZJGSU Online Judge Version 15.03.01 @ <a href="https://github.com/ZJGSU-Open-Source/GoOnlineJudge" target="_blank">Github</a></div></center>
            <center><div class="center">Copyright © 2013-2015 ZJGSU ACM Club</div></center>
